...
namespace App\Http\Controllers\Frontend\Cleave;

use Illuminate\Http\Request;
use App\Http\Controllers\Controller;

use App\Models\Cleave;

class CleaveController extends Controller
{
    /**
    ...
    {
        return view('frontend.hrs.compasionate.create');
    }
    ...
    {
        Cleave::updateOrCreate(['id' => $request->id],
