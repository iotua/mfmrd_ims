...
<div class="container">    
        ...
        <br />
        <h3 align="center">MAIL Recording System - Outgoing</h3>
        <br />
        <div class="pull-right">
            <a class="btn btn-success" href="{{ route('frontend.out.create') }}">New Outgoing Mail</a>
        </div>
        <br />
        @if(session()->get('success'))
            <div class="alert alert-success">
      ...
      <div class="table-responsive">
       <table class="table table-bordered table-striped" id="user_table">
              <thead>
               <tr>                     
                       <th width="15%">Date</th>
                       <th width="35%">Mail Subject</th>    
                       <th width="20%">Concern Officer</th>                        
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#user_table').DataTable({
                ...
                ajax:{
                    url: "{{ route('frontend.out.index') }}",
                },
                columns:[        
                    { data: 'date', name: 'date' },
                    { data: 'mailsubject', name: 'mailsubject' },
                    { data: 'concernofficer', name: 'concernofficer' },
