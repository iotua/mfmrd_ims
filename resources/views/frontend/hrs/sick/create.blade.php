...
@section('content')  
<h1>New Medical Certificate details </h1>

<form action="{{ route('frontend.sick.store')}}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
<input type="hidden" name="hrs_id" id="hrs_id" value={{request()->route('id')}}>
    ...
    <div class="form-group">
            <label class="control-label col-md-4">Select Medical Certificate: </label>
            <div class="col-md-8">
