            ...
            @auth
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right text-left multi-level" aria-labelledby="dropdown01">
                        ...
                        @can('mrs.view')
                        <a href="{{ route('frontend.in.index') }}" class="dropdown-item">Mail Recording System - Incoming</a>
                        <a href="{{ route('frontend.out.index') }}" class="dropdown-item">Mail Recording System - Outgoing</a>
                           
                        @endcan
                        @can('pms.view')
                        <li class="nav-item|view backend">     
                            <a href="{{ route('frontend.user.dashboard') }}" class="dropdown-item">Project Management System</a>
                        </li>
                        @endcan
